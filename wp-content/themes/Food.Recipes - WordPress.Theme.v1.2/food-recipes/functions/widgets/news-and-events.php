...
/********* Starting Recipe News and Events Widget Function *********/
	...
	function widget($args,  $instance) {
		...
		echo   '<div class="widget newsEvent nostylewt">
...
/********* Recipe News and Events Loop *********/
	...
	function news_and_event_loop($post_count = '3', $excerpt_length = 23){
...
/********* Starting Recipe News and Events Widget Admin Form *********/
	...
	{	
		$instance = wp_parse_args( (array) $instance, array( 'title' => __('News and Events', 'FoodRecipe'),'post_per_page' => 3,'excerpt_length' => 12 ) );
