...
/********* Starting Recipe Sidebar Tabs Widget Function *********/
	...
	function widget($args,  $instance) {
			...
			echo '<div class="widget fav-recipes nostylewt">
									<h2 class="w-bot-border">';
					  						echo $title;
			echo 					'</h2>
											<div class="tabed">
													<ul class="tabs clearfix">';
															if($tab_title_one) echo '<li class="current">'. $tab_title_one .'<span></span></li>';
															if($tab_title_two) echo '<li>'. $tab_title_two .'<span></span></li>';
															if($tab_title_three) echo '<li>'. $tab_title_three .'<span></span></li>';
			echo									'</ul>
			...
			if($tab_title_two) {			echo	'<div class="block">
															<ul class="highest">';
			...
			if($tab_title_three) {			echo	'<div class="block">
															<ul class="highest">';
	...
	function recipe_loop($loop_type = 'popular_posts'){
			...
			if($get_posts_query->have_posts()): 
					...
					global $post;
						?>
							<li>
									<a href="<?php the_permalink(); ?>" class="img-box"><?php the_post_thumbnail('sidebar-tabs'); ?></a>
...
/********* Starting Recipe Sidebar Tabs Widget Admin Form *********/
	...
	{	
		$instance = wp_parse_args( (array) $instance, array('title' => __('MISC Recipes', 'FoodRecipe'),
															'tab_title_one' => __('Recent', 'FoodRecipe'),
															'tab_title_two' => __('Popular', 'FoodRecipe'),
															'tab_title_three' => __('Random', 'FoodRecipe'),
