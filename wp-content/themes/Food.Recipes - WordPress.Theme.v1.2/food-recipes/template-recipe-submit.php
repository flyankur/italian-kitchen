										...
										if(!$show_message)
										{
												...
												<form id="recipe-form" name="recipe-form" action="" method="post"  enctype="multipart/form-data">
														...
														<fieldset class="recipe-image">
                                                            ...
                                                            <span class="note">* <?php _e('<strong>Image size must be more than 575px in width and 262px in height.','FoodRecipe');?></span>
														</fieldset>
														<fieldset class="incobjs ingre-wrap">
                                                            ...
                                                            <span class="note">Use + button on the right to add new ingredient.</span>
														</fieldset>
                                                        <fieldset class="incobjs steps-wrap">
                                                            ...
                                                            <span class="more-ingre">+</span>
                                                            <span class="note">Use + button on the right to add new step.</span>
                                                        </fieldset>
                                                        <fieldset>
                                                            ...
                                                            <span class="note">A Video Based recipe does not display attached images and only display a video at top.</span>
                                                        </fieldset>
                                                        <fieldset>
                                                            ...
                                                            <span class="note">* <?php _e('Provide the video embed code and <strong>Modify the width attribute to 575px and height attribute to 262px.','FoodRecipe');?></span>
                                                        </fieldset>
														<!-- recipe detail -->
