		...
		array(
			...
			'options'	=> array (
				...
				array(
					...
					'desc'	=> __('Type the address you wish to display for the map u can use multiple address EX: Address1 | Address2 | Address3 .','ATP_ADMIN_SITE'),
					'info'	=> '(optional)',
					'id'	=> 'address',
					'std'	=> '',
					'type'	=> 'text',
				...
				array(
					...
					'desc'	=> __('u can use multiple Marker Description EX: Description1 | Description2 | Description3.','ATP_ADMIN_SITE'),
					'id'	=> 'marker_desc',
					'std'	=> '',
					'type'	=> 'text',
					'inputsize'	=> '53',
		...
		array(
			...
			'options'	=> array(
				...
				array(
					...
					'id'	=> 'blogstyle',
					'std'	=> '',
					'desc'	=> __('Choose the style to display the blog posts','atp_admin'),
					'options' => array(
						''			=> __('Choose one...','atp_admin'),				
						'post1'		=> 'Blog Style1',
						'post2'		=> 'Blog Style2',
		...
		array(
			...
			'options'	=> array(
				...
				array(
					...
					'id'	=> 'titlelink',
					'desc'	=> __('If the option is on, It will display the title href link to its post.','atp_admin'),
					'std'	=> true,
					'type'	=> 'checkbox'
				),
				array(
				...
				array(
					...
					'id'	=> 'columns',
					'desc'	=> __('If the option is on, it will display the list in 2 columns layout.','atp_admin'),
					'std'	=> false,
					'type'	=> 'checkbox'
				),
			),	
