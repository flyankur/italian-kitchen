	...
	class myCustomFields {
		...
		*/
		var $customFields =	array(
			...
			array(
				"name"			=> "categories",
				"title"			=> "Page categories for the Menu Card, Gallery or Blog page",
				"description"	=> "The categories to use for the Menu Card, Gallery or Blog page. Please don't use the same categories on multiple pages.",
				"type"			=>	"categories",
				"scope"			=>	array( "page" ),
				"capability"	=> "edit_page"
			),
		...
		*/
		function createCustomFields() {
			if ( function_exists( 'add_meta_box' ) ) {
				...
				add_meta_box( 'my-custom-fields', 'Additional Settings', array( &$this, 'displayCustomFields' ), 'post', 'side', 'high' );
			}
		}
		/**
