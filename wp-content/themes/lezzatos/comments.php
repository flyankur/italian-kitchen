<div id="comment-list">
<?php if ($comments) : ?>
<h4 id="comment-title"><?php echo __('Comments','Lezzatos'); ?> (<?php comments_number( '0', '1', '%' ); ?>)</h4>
    ...
    <?php foreach ($comments as $comment) : ?>
        ...
        <em><?php echo __('Your comment is awaiting moderation.','Lezzatos'); ?></em>
        <?php endif; ?>
 ...
 <?php else :  ?>
    <?php if ('open' == $post->comment_status) : ?>
     ...
     <?php else : ?>
        ...
        <p class="nocomments"><?php echo __('Comments are closed.','Lezzatos'); ?></p>
    <?php endif; ?>
<?php endif; ?>
<div class="clear"></div>
...
<?php if ( comments_open() ) : ?>
	...
	<div id="respond" >
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<p><input class="button" name="submit" type="submit" id="submit" tabindex="5" value="<?php echo __('Submit Comment','Lezzatos'); ?>" />
